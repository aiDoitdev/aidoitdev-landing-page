  ...
  const steps = [
    {
      ...
      description: "Book a quick consultation to discuss your app or SaaS idea. We'll help you refine your vision and outline the next steps.",
      output: "A clear plan tailored to your project goals.",
      icon: (
